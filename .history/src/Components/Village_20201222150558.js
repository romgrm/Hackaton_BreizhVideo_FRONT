...
export default function Village() {
    ...
    const [creatz, setVill] = useState(initialState);

    const handleInputChange = event => {
        const { name, value } = event.target;
        setVill({ ...creatz, [name]: value });
    };
    ...
    const saveVillage = () => {
        ...
        useEffect(() => {
            async function postData() {
                ...
                const postVillage = await axios.post('http://localhost:8080/Village', creatz)
            ...
            <div>
                ...
                <form>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="name" aria-describedby="emailHelp" onChange={handleInputChange} name="name" value={creatz.name} />
