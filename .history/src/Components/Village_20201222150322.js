...
export default function Village() {
    ...
    const handleInputChange = event => {
        ...
        setAddVillage({ ...addVillage, [name]: value });
    };
    ...
    const saveVillage = () => {
        ...
        useEffect(() => {
            async function postData() {
                ...
                const postVillage = await axios.post('http://localhost:8080/Village', addVillage)
            ...
            <div>
                ...
                <form>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="name" aria-describedby="emailHelp" onChange={handleInputChange} name="name" value={addVillage.name} />
