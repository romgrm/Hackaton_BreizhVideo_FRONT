...
export default function Village() {
    ...
    useEffect(() => {
        ...
        fetchData();
         ...
         deleteData= (id, e) =>{
            const url2 = await axios.delete(`http://localhost:8080/Village/${id}` )
            setSuppr(url2)
        }
        ...
        <div>
            <table className="table w-75">
                ...
                <tbody>
                    ...
                    <i onClick={deleteData(event.target.value)} style={{cursor: 'pointer', color: '#18A2B8'}} className="fas fa-trash fa-lg ml-5"></i>
                    </tr>
                    {/* <tr>
      <th scope="row">2</th>
      <td></td>
