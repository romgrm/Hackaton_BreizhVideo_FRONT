...
export default function Village() {
    ...
    const [ajo, setajo] = useState(initialState);

    const handleInputChange = event => {
        const { name, value } = event.target;
        setajo({ ...ajo, [name]: value });
    };
    ...
    const saveVillage = () => {
        ...
        useEffect(() => {
            async function postData() {
                ...
                const postVillage = await axios.post('http://localhost:8080/Village', ajo)
            ...
            <div>
                ...
                <form>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="name" aria-describedby="emailHelp" onChange={handleInputChange} name="name" value={ajo.name} />
