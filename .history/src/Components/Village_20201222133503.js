...
export default function Village() {
    ...
    useEffect(() => {
        async function postData() {
            ...
            const villagePost = { id: 2, name: 'Nantes', postCode: '44000' };
            const response = await axios.post('http://localhost:8080/Village', village)
                .then(response => setVillage(response.data.name));
        }
