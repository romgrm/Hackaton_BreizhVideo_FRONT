...
export default function Village() {
    ...
    const [create, setVill] = useState(initialState);

    const handleInputChange = event => {
        const { name, value } = event.target;
        setVill({ ...create, [name]: value });
    };
    ...
    const saveVillage = () => {
        ...
        useEffect(() => {
            async function postData() {
                ...
                const postVillage = await axios.post('http://localhost:8080/Village', create)
            ...
            <div>
                ...
                <form>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="name" aria-describedby="emailHelp" onChange={handleInputChange} name="name" value={create.name} />
